...
int main(int argc, char **argv)
{
    ...
    */
    ...
    // Sift / Surf features can be initialized using : 
    //    cv::Ptr<cv::FeatureDetector> detect = new cv::SiftFeatureDetector;
    //    cv::Ptr<cv::DescriptorExtractor> detect = new cv::SiftDescriptorExtractor;
